...
class MachineModel {
  ...
  factory MachineModel.fromMap(Map<String, dynamic> m) => MachineModel(
    ...
    nextCalibration: m['equipment_next_calibration'] != null
        ...
        : null,
    calibrationIntervalDays: m['equipment_calibration_interval_days'] != null
    ...
    nextMaintenance: m['equipment_next_maintenance'] != null
        ...
        : null,
    maintenanceIntervalDays: m['equipment_maintenance_interval_days'] != null
  ...
  Map<String, dynamic> toInsertMap() => {
    ...
    if (patrimonyNumber != null) 'equipment_patrimony_number': patrimonyNumber,
    if (locationId != null) 'equipment_location_id': locationId,
    if (room != null) 'equipment_room': room,
    if (purchaseDate != null)
      'equipment_purchase_date': purchaseDate!.toIso8601String().substring(
        0,
        10,
      ),
    if (warrantyUntil != null)
      'equipment_warranty_until': warrantyUntil!.toIso8601String().substring(
        0,
        10,
      ),
    if (lastCalibration != null)
      'equipment_last_calibration': lastCalibration!
          .toIso8601String()
          .substring(0, 10),
    if (nextCalibration != null)
      'equipment_next_calibration': nextCalibration!
          .toIso8601String()
          .substring(0, 10),
    if (calibrationIntervalDays != null)
      'equipment_calibration_interval_days': calibrationIntervalDays,
    if (lastMaintenance != null)
      'equipment_last_maintenance': lastMaintenance!
          .toIso8601String()
          .substring(0, 10),
    if (nextMaintenance != null)
      'equipment_next_maintenance': nextMaintenance!
          .toIso8601String()
          .substring(0, 10),
