          ...
          if (_expanded && widget.children.isNotEmpty) ...[
            ...
            if (widget.onReorderChildren != null)
              ReorderableListView(
                ...
                onReorderItem: widget.onReorderChildren!,
                children: [
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border(
            bottom: BorderSide(color: context.appBorder.withValues(alpha: 0.5)),
          ),
        ),
        child: Row(
          children: [
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Divider(height: 1, color: context.appBorder),
          ...locations.map((l) => _ChildTile(loc: l, onTap: () => onTap(l))),
          Material(
            color: Colors.transparent,
            child: InkWell(
              onTap: onAdd,
...
class _QuickAddLocationDialog extends StatefulWidget {
  ...
  @override
  State<_QuickAddLocationDialog> createState() =>
      _QuickAddLocationDialogState();
}
                    ...
                    items: [
                      ...
                      ...widget.rooms.asMap().entries.map(
                        (entry) => DropdownMenuItem<int?>(
                          ...
                          child: Text(
                            '${entry.value.code ?? roomCode(entry.key)} · ${_stripCodePrefix(entry.value.name)}',
                            style: GoogleFonts.spaceGrotesk(
                              color: context.appTextPrimary,
                              fontSize: 13,
                            ),
    ...
    return AlertDialog(
      ...
      content: SizedBox(
        ...
        child: _entries.isEmpty
            ? Center(
                child: Text(
                  'This room has no sub-locations.',
                  style: GoogleFonts.spaceGrotesk(
                    color: context.appTextMuted,
                    fontSize: 13,
                  ),
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(
                                width: 60,
                                child: Text(
                                  e.code ?? childCode(widget.roomIndex, i),
                                  style: GoogleFonts.jetBrainsMono(
                                    color: ctx.appTextMuted,
                                    fontSize: 11,
                                    fontWeight: FontWeight.w600,
