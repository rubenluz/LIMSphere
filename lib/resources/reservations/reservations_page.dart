...
class _ReservationsPageState extends State<ReservationsPage> {
      ...
      setState(() {
        _all = cachedRes
            .map<ReservationModel>(
              (r) =>
                  ReservationModel.fromMap(Map<String, dynamic>.from(r as Map)),
            )
            .toList();
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    items: [
                      ...
                      ...ReservationModel.statusOptions.map(
                        (s) => DropdownMenuItem(
                          value: s,
                          child: Text(
  ...
  Widget _buildListView(BuildContext context) {
    ...
    final future = _filtered.where((r) => r.end.isAfter(now)).toList()
      ..sort((a, b) => a.start.compareTo(b.start));
    final past = _filtered.where((r) => r.end.isBefore(now)).toList()
    ...
    return ListView(
      ...
      children: [
        if (future.isNotEmpty) ...[
          _ListSectionHeader('Upcoming & Ongoing (${future.length})'),
