    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: active
                ? AppDS.accent.withValues(alpha: 0.4)
                : Colors.transparent,
          ),
        ),
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                field.content.length > 16
                    ? '${field.content.substring(0, 16)}…'
                    : field.content,
                style: TextStyle(
                  fontSize: 11,
                  color: active ? AppDS.accent : context.appTextPrimary,
                ),
                  ...
                  children: [
                    Container(
                      ...
                      decoration: isSelected
                          ...
                          ? BoxDecoration(
                              border: Border.all(
                                color: AppDS.accent.withValues(alpha: 0.5),
                                width: 1.0,
                    ...
                    if (isSelected)
                      Positioned(
                        ...
                        child: GestureDetector(
                          onPanUpdate: (d) =>
                              onResize(f.id, d.delta.dx, d.delta.dy),
                          child: Container(
                            width: 14,
                            height: 14,
                            decoration: BoxDecoration(
