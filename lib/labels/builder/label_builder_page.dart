          ...
          Tooltip(
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Icon(Icons.open_in_new_rounded, size: 15, color: context.appTextSecondary),
              ),
            ),
          ),
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: _quickPrinting
                    ...
                    : Icon(Icons.print_rounded, size: 15, color: context.appTextSecondary),
              ),
            ),
          ),
          const SizedBox(width: 4),
          SizedBox(height: 20, child: VerticalDivider(color: context.appBorder)),
          const SizedBox(width: 4),
                ...
                Padding(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<int>(
                      ...
                      dropdownColor: context.appSurface,
                      icon: Icon(Icons.expand_more_rounded, size: 14, color: context.appTextSecondary),
                      selectedItemBuilder: (_) => List.generate(_previewRows.length, (i) =>
                        Align(
                          alignment: Alignment.centerLeft,
                          child: Text(
