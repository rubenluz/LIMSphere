  ...
  LabelTemplate(
    ...
    fields: [
      ...
      LabelField(
        id: 'bi_m3',
        type: LabelFieldType.text,
        content: '{strain_scientific_name}',
        x: 0.5,
        y: 9.5,
        w: 61,
        h: 5.5,
  ...
  LabelTemplate(
    ...
    fields: [
      ...
      LabelField(
        id: 'bi_ta3',
        type: LabelFieldType.text,
        content: '{fish_stocks_responsible}',
        x: 35,
        y: 0.5,
        w: 25,
        h: 5.5,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${template.labelW.toInt()}×${template.labelH.toInt()} mm · ${template.fields.length} fields',
                  style: TextStyle(
                    fontSize: 10,
