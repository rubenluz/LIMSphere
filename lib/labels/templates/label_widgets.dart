              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Use "Starters" to add a pre-built template, or "New Template" to build from scratch.',
                        style: TextStyle(
                          fontSize: 12,
                          color: context.appTextMuted,
                        ),
...
class _ProfileSwitcherChip extends StatelessWidget {
  ...
  void _showMenu(BuildContext context) {
    ...
    showMenu<PrinterProfile>(
      ...
      items: profiles
          .map(
            (p) => PopupMenuItem<PrinterProfile>(
              value: p,
              child: Row(
                children: [
                  Icon(
    ...
    try {
      ...
      final rows =
          await Supabase.instance.client
                  .from(table)
                  .select(_selectForCategory(widget.template.category))
                  .limit(100)
              as List<dynamic>;
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${widget.template.labelW.toInt()}×${widget.template.labelH.toInt()} mm · ${widget.template.fields.length} fields',
                      style: TextStyle(
                        fontSize: 11,
                        color: context.appTextSecondary,
                      ),
...
class _IconBtn extends StatelessWidget {
  ...
  const _IconBtn({
    ...
    this.color = AppDS.textSecondary,
  });
