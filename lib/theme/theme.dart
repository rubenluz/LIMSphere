...
class AppDS {
  // Shared module chrome (Reagents is the visual reference).
  static const double moduleToolbarHeight = 56;
  static const double moduleTitleIconSize = 18;
  static const double moduleMenuIconSize = 20;
  static const double moduleActionIconSize = 18;
  static const double moduleTitleFontSize = 16;
  static const double moduleSearchHeight = 36;
  static const double moduleSearchFontSize = 13;
  static const double moduleSearchIconSize = 16;
  static const double moduleClearIconSize = 14;
  static const EdgeInsets moduleToolbarPadding = EdgeInsets.symmetric(
    horizontal: 16,
  );
  ...
  static const Color reagentsAccent = Color(0xFFF59E0B);
  static const Color machinesAccent = Color(0xFF14B8A6);
  ...
  static const Color blue = Color(
    0xFF60A5FA,
  ); // blue-400: sort handles, drag indicators
  static const Color blue500 = Color(
    0xFF3B82F6,
  ); // blue-500: focus rings, inline links
  static const Color blue800 = Color(
    0xFF1E40AF,
  ); // blue-800: selected-column header bg
  static const Color indigo = Color(
    0xFF6366F1,
  ); // indigo-500: menu section / user avatar

  // ── Semantic layout colors ────────────────────────────────────────────────────
  static const Color pageBg = Color(
    0xFFF1F5F9,
  ); // light scaffold background (slate-100)
  static const Color fabBg = Color(
    0xFF1E3A5F,
  ); // dark navy FAB / primary action button
  static const Color toolbarIcon = Color(
    0xB3FFFFFF,
  ); // white 70%: icon on dark toolbar/appbar
  static const Color shadow = Color(
    0x28000000,
  ); // black ~16%: default box shadow
  ...
  static TextStyle moduleTitle(Color color) => GoogleFonts.spaceGrotesk(
...
extension AppThemeContext on BuildContext {
  ...
  Color get appTextPrimary =>
      isDark ? AppDS.textPrimary : const Color(0xFF0F172A);
  Color get appTextSecondary =>
      isDark ? AppDS.textSecondary : const Color(0xFF475569);
