        ...
        child: Column(
          ...
          children: [
            const Icon(Icons.people_outline,
                size: 52, color: AppDS.textMuted),
            const SizedBox(height: 14),
            Text(
              _users.isEmpty ? 'No users found.' : 'No users match.',
              style: GoogleFonts.spaceGrotesk(
                  fontSize: 14, color: AppDS.textSecondary),
            ),
          ],
        ),
      );
          ...
          SizedBox(
            ...
            child: Tooltip(
              ...
              child: InkWell(
                onTap: () => _openDetail(u),
                child: Center(
                  child: _AvatarCircle(user: u, size: 24),
                ),
              ),
            ),
          ),
...
class _AvatarCircle extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = _UsersPageState._roleColor(user.role);
