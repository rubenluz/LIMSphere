...
class _DocViewerPageState extends State<DocViewerPage> {
  ...
  void _snack(String msg, {bool isError = false}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Text(msg, style: const TextStyle(color: AppDS.textPrimary)),
      ...
      appBar: AppBar(
          ...
          children: [
            Text(
              ...
              style: GoogleFonts.spaceGrotesk(
                  fontSize: 14, fontWeight: FontWeight.w600, color: AppDS.textPrimary),
        ...
        actions: [
          TextButton.icon(
            ...
            icon: const Icon(Icons.open_in_new, size: 15, color: AppDS.textSecondary),
        ...
        bottom: PreferredSize(
          ...
          child: Container(height: 1, color: AppDS.border),
        ),
      ),
    ...
    return Scrollbar(
      ...
      child: SingleChildScrollView(
        ...
        child: SelectableText(
          text,
          style: GoogleFonts.jetBrainsMono(fontSize: 13, color: AppDS.textPrimary, height: 1.6),
        ),
      ),
    );
  }
          ...
          child: Scrollbar(
            ...
            child: SingleChildScrollView(
              ...
              child: SelectableText(
                _docText ?? '',
                style: GoogleFonts.spaceGrotesk(
                    fontSize: 13, color: AppDS.textPrimary, height: 1.7),
              ),
            ),
          ),
        ),
