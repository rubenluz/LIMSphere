...
class _SopPageState extends State<SopPage> {
  ...
  void _snack(String msg, {bool isError = false}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Text(msg, style: const TextStyle(color: _DS.textPrimary)),
      backgroundColor: isError ? _DS.red : _DS.surface3,
    ));
  }
    ...
    if (_filtered.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            const Icon(Icons.menu_book_outlined, size: 52, color: _DS.textMuted),
            ...
            Text(
              ...
              style: GoogleFonts.spaceGrotesk(
                  fontSize: 14, color: _DS.textSecondary),
            ),
          ],
        ),
      );
            ...
            Row(
              children: [
                _ActionBtn(icon: Icons.edit_outlined, label: 'Edit',
                    color: _DS.textSecondary, onTap: onEdit),
                if (onOpenPdf != null) ...[
      ...
      children: [
        Text('Attachments',
            style: GoogleFonts.spaceGrotesk(
                ...
                color: _DS.textMuted, letterSpacing: 0.5)),
        const SizedBox(height: 6),
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
...
class _MetaItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final c = color ?? _DS.textSecondary;
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
...
class _DropFilter extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(8),
      border: Border.all(
          color: value != null ? _DS.accent : _DS.border),
    ),
    child: DropdownButtonHideUnderline(
      child: DropdownButton<String?>(
        ...
        icon: Icon(Icons.expand_more,
            size: 16,
            color: value != null ? _DS.accent : _DS.textMuted),
      ),
    ),
  );
}
      ...
      TextFormField(
        ...
        decoration: InputDecoration(
          ...
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(6),
            borderSide: const BorderSide(color: _DS.border2),
          ),
