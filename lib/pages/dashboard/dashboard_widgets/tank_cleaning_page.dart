  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(color: AppDS.textPrimary),
        title: Row(children: [
          const Icon(Icons.cleaning_services_outlined, size: 18, color: AppDS.accent),
          const SizedBox(width: 8),
          Text('Tank Cleaning Schedule',
              style: GoogleFonts.spaceGrotesk(
                  color: AppDS.textPrimary, fontWeight: FontWeight.w600, fontSize: 16)),
        ]),
        actions: [
          IconButton(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return Container(
                          decoration: BoxDecoration(
                            color: i.isEven ? AppDS.surface : AppDS.bg,
                            border: const Border(
