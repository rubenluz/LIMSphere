  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _all = rows
              .map<ReservationModel>((r) => ReservationModel.fromMap(r))
              .toList();
  ...
  Widget _buildCalendarView() {
    ...
    return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Container(
        width: 380,
        decoration: const BoxDecoration(
          border: Border(right: BorderSide(color: AppDS.border)),
        ),
    ...
    if (_filtered.isEmpty) {
      return Center(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          const Icon(Icons.event_outlined, size: 48, color: AppDS.textMuted),
        ...
        child: Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            Icon(icon,
                size: 14,
                color:
                    active ? const Color(0xFFEC4899) : AppDS.textSecondary),
...
class _ReservationFormDialogState extends State<_ReservationFormDialog> {
        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              // Date/time pickers
              Row(children: [
                Expanded(child: _dtPicker('Start', _start, () => _pickDateTime(true))),
                const SizedBox(width: 10),
                Expanded(child: _dtPicker('End', _end, () => _pickDateTime(false))),
              ]),
              ...
              _f(_purposeCtrl, 'Purpose'),
              const SizedBox(height: 10),
              _f(_projectCtrl, 'Project'),
              const SizedBox(height: 10),
  ...
  Widget _dtPicker(String label, DateTime dt, VoidCallback onTap) =>
      GestureDetector(
        onTap: onTap,
        child: Container(
