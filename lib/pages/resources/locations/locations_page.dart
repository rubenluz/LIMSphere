...
class _LocationsPageState extends State<LocationsPage> {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          ...
          style: GoogleFonts.spaceGrotesk(color: _DS.textSecondary),
        ),
        actions: [
          TextButton(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child:
                Text('Copy Link', style: GoogleFonts.spaceGrotesk(color: _DS.accent)),
          ),
          TextButton(
        ...
        Expanded(
          child: SizedBox(
            ...
            child: TextField(
              ...
              style:
                  GoogleFonts.spaceGrotesk(color: _DS.textPrimary, fontSize: 13),
              decoration: InputDecoration(
                hintText: 'Search locations...',
                hintStyle:
                    GoogleFonts.spaceGrotesk(color: _DS.textMuted, fontSize: 13),
                prefixIcon:
                    const Icon(Icons.search, color: AppDS.textMuted, size: 16),
  ...
  Widget _buildBody() {
    ...
    if (visibleRooms.isEmpty && visibleOrphans.isEmpty) {
      return Center(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          const Icon(Icons.place_outlined, size: 48, color: AppDS.textMuted),
          const SizedBox(height: 12),
          Text(
            q.isEmpty
            ...
            style: GoogleFonts.spaceGrotesk(color: _DS.textMuted, fontSize: 15),
          ),
        ]),
      );
    }
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            const Icon(Icons.add, size: 13, color: AppDS.textMuted),
            const SizedBox(width: 4),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(
          ...
          child: Row(children: [
            const Icon(Icons.inbox_outlined, color: AppDS.textMuted, size: 16),
            const SizedBox(width: 8),
            Text('Unassigned',
                style: GoogleFonts.spaceGrotesk(
...
class _Btn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      icon: Icon(icon, size: size, color: AppDS.textSecondary),
      tooltip: tooltip,
      onPressed: onPressed,
