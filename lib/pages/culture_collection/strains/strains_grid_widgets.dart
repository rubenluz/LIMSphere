    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selected ? AppDS.accent.withValues(alpha: 0.15) : AppDS.surface2,
          borderRadius: BorderRadius.circular(6),
          border: Border.all(
              color: selected ? AppDS.accent.withValues(alpha: 0.5) : AppDS.border),
        ),
      ...
      child: _editing
          ? SizedBox(
              ...
              child: TextField(
                ...
                style: GoogleFonts.jetBrainsMono(fontSize: 11, fontWeight: FontWeight.w700, color: AppDS.textPrimary),
