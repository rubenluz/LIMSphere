...
class _FishTanksPageState extends State<FishTanksPage> {
  ...
  Future<void> _loadFromSupabase() async {
    try {
      ...
      // Detect all rack IDs from DB and add any that aren't pre-built
        ...
        Column(children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              _chip('${tanks.length} tanks',  AppDS.textMuted),
              const SizedBox(width: 6),
              _chip('$occupied occupied',     AppDS.green),
              const SizedBox(width: 6),
              _chip('$empties empty',         AppDS.textSecondary),
              if (sentinels > 0) ...[
                const SizedBox(width: 6),
                  ...
                  PopupMenuItem(
                    ...
                    child: Row(children: [
                      Icon(Icons.delete_outline, size: 16,
                        color: _racks.length > 1 ? AppDS.red : AppDS.textMuted),
                      const SizedBox(width: 8),
          ...
          Container(height: 1, color: AppDS.border),
  ...
  Widget _buildRack(double availW) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppDS.border2, width: 1.5),
        boxShadow: [BoxShadow(
              ...
              children: [
                ...
                if (!isTop) ...[
                  ...
                  Text('3.5L', style: GoogleFonts.jetBrainsMono(
                    fontSize: 8, color: AppDS.textMuted)),
                ],
              ],
            ),
          ),
    ...
    if (isSent) {
      ...
      switch (tank.zebraStatus) {
        ...
        case 'active':
          ...
          break;
        default: // empty
          bg = Colors.white.withValues(alpha:0.80); border = const Color(0xFFBDD4E8);
      }
    }
                  ...
                  Positioned(top: 0, right: 0,
                    child: Container(
                      ...
                      child: Text(tank.volumeLabel,
                        style: GoogleFonts.jetBrainsMono(
                          fontSize: 8.5, color: const Color(0xFF475569))))),
                // Health dot
                if (occupied)
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            _mi(Icons.info_outline,  'View Details', AppDS.textPrimary, () {
            ...
            if (isOcc || (tank.zebraLine?.isNotEmpty ?? false))
              _mi(Icons.edit_outlined, 'Edit Tank', AppDS.textPrimary, () {
                setState(() => _menuTank = null);
    ...
    showDialog(context: context, builder: (ctx) => AlertDialog(
      ...
      content: SizedBox(width: 280,
        child: TextField(
          controller: ctrl,
          autofocus: true,
          style: GoogleFonts.jetBrainsMono(color: AppDS.textPrimary),
          decoration: InputDecoration(
            labelText: 'Rack name (e.g. R2)',
            labelStyle: GoogleFonts.spaceGrotesk(color: AppDS.textSecondary),
            filled: true, fillColor: AppDS.surface3,
            border: OutlineInputBorder(borderSide: const BorderSide(color: AppDS.border)),
      ...
      actions: [
        TextButton(
          ...
          child: Text('Cancel', style: GoogleFonts.spaceGrotesk(color: AppDS.textSecondary))),
        ElevatedButton(
  ...
  void _showDeleteRackDialog() {
    ...
    showDialog(context: context, builder: (ctx) => AlertDialog(
      ...
      content: Text(
        ...
        style: GoogleFonts.spaceGrotesk(fontSize: 13, color: AppDS.textSecondary)),
      actions: [
        TextButton(
          onPressed: () => Navigator.pop(ctx),
          child: Text('Cancel', style: GoogleFonts.spaceGrotesk(color: AppDS.textSecondary))),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Text(title, style: GoogleFonts.spaceGrotesk(
            fontSize: 13, fontWeight: FontWeight.w700, color: AppDS.textPrimary)),
        ]),
    ...
    final header = Padding(
      ...
      child: Row(children: [
        SizedBox(width: 56, child: Text('Tank', style: GoogleFonts.spaceGrotesk(
          fontSize: 10, fontWeight: FontWeight.w700, color: AppDS.textMuted))),
        Expanded(child: Text('Line', style: GoogleFonts.spaceGrotesk(
          fontSize: 10, fontWeight: FontWeight.w700, color: AppDS.textMuted))),
        SizedBox(width: 28, child: Text('♂', textAlign: TextAlign.center,
          style: GoogleFonts.spaceGrotesk(fontSize: 10, fontWeight: FontWeight.w700, color: AppDS.textMuted))),
        SizedBox(width: 28, child: Text('♀', textAlign: TextAlign.center,
          style: GoogleFonts.spaceGrotesk(fontSize: 10, fontWeight: FontWeight.w700, color: AppDS.textMuted))),
      ...
      : stockTanks.map((t) => Padding(
          ...
          child: Row(children: [
            ...
            SizedBox(width: 28, child: Text('${t.zebraMales ?? 0}', textAlign: TextAlign.center,
              style: GoogleFonts.jetBrainsMono(fontSize: 11, color: AppDS.textSecondary))),
  ...
  Widget _buildFishByLineWidget() {
    ...
    final dataRows = sorted.map((e) => Padding(
      ...
      child: Row(children: [
        ...
        cell(e.value.$3, colJ, AppDS.textMuted),
        cell(e.value.$4, colT, AppDS.textPrimary, bold: true),
      ]),
    )).toList();
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(e.key, style: GoogleFonts.spaceGrotesk(
                      fontSize: 12, color: AppDS.textPrimary)),
                    Text('${e.value} fish total', style: GoogleFonts.jetBrainsMono(
                      fontSize: 10, color: AppDS.textMuted)),
                  ])),
                hasAmount
...
class _EditTankDialogState extends State<_EditTankDialog> {
    ...
    return AlertDialog(
      ...
      title: Row(children: [
        ...
        Text(widget.tank.volumeLabel,
          style: GoogleFonts.jetBrainsMono(fontSize: 10, color: AppDS.textMuted)),
      ]),
      content: SizedBox(
        width: 540,
      ...
      actions: [
        OutlinedButton(
          ...
          style: OutlinedButton.styleFrom(
            foregroundColor: AppDS.textSecondary,
  ...
  InputDecoration _inputDec() => InputDecoration(
    isDense: true, filled: true, fillColor: AppDS.surface3,
          ...
          ...rackList.map((r) => Padding(
            ...
            child: InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: _rack == r
                      ? AppDS.accent.withValues(alpha: 0.2) : AppDS.surface2,
                  borderRadius: BorderRadius.circular(6),
                  border: Border.all(
                    color: _rack == r ? AppDS.accent : AppDS.border,
                    width: _rack == r ? 1.5 : 1)),
                child: Center(child: Text(r, style: GoogleFonts.jetBrainsMono(
                  fontSize: 11, fontWeight: FontWeight.w700,
                  color: _rack == r ? AppDS.accent : AppDS.textSecondary))),
              ),
            ),
          )),
        ]),
            ...
            child: InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(6),
                  border: Border.all(
                    color: _row == r ? AppDS.accent : AppDS.border,
                    width: _row == r ? 1.5 : 1)),
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text(r, style: GoogleFonts.jetBrainsMono(
                    fontSize: 12, fontWeight: FontWeight.w700,
                    color: _row == r ? AppDS.accent : AppDS.textSecondary)),
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: occupied
                      ...
                      : (sel ? AppDS.accent.withValues(alpha: 0.18) : AppDS.surface2),
                  borderRadius: BorderRadius.circular(5),
                  border: Border.all(
                    color: occupied
                        ? AppDS.red.withValues(alpha: 0.5)
                        : (sel ? AppDS.accent : AppDS.border),
                    width: sel ? 1.5 : 1)),
                child: Center(child: Text('$c', style: GoogleFonts.jetBrainsMono(
                  fontSize: 11, fontWeight: FontWeight.w600,
                  color: occupied
                      ? AppDS.red
                      : (sel ? AppDS.accent : AppDS.textSecondary)))),
              ),
            );
          }),
        ),
