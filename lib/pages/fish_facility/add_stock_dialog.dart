    ...
    return AlertDialog(
      ...
      title: Text(
        ...
        style: GoogleFonts.spaceGrotesk(
          color: AppDS.textPrimary, fontWeight: FontWeight.w700, fontSize: 16)),
      content: SizedBox(
        width: 480,
              ...
              child: InkWell(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(6),
                    border: Border.all(
                      color: _selectedRack == rack ? AppDS.accent : AppDS.border,
                      width: _selectedRack == rack ? 1.5 : 1),
                  ),
                  child: Center(child: Text(rack, style: GoogleFonts.jetBrainsMono(
                    fontSize: 11, fontWeight: FontWeight.w700,
                    color: _selectedRack == rack ? AppDS.accent : AppDS.textSecondary))),
                ),
              ),
            )),
          ]),
              ...
              child: InkWell(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(6),
                    border: Border.all(
                      color: _selectedRow == r ? AppDS.accent : AppDS.border,
                      width: _selectedRow == r ? 1.5 : 1),
                  ),
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text(r, style: GoogleFonts.jetBrainsMono(
                      fontSize: 12, fontWeight: FontWeight.w700,
                      color: _selectedRow == r ? AppDS.accent : AppDS.textSecondary)),
  ...
  Widget _fMono(String label, TextEditingController ctrl) => Column(
    ...
    children: [
      ...
      TextField(
        ...
        style: GoogleFonts.jetBrainsMono(color: AppDS.textPrimary, fontSize: 13),
        decoration: _inputDec()),
    ],
  );
