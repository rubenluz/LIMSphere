    ...
    try {
      ...
      for (final row in rows as List) {
        final last = DateTime.tryParse(
          row['fish_stocks_last_tank_cleaning'].toString(),
        );
        final interval = int.tryParse(
          row['fish_stocks_cleaning_interval_days'].toString(),
        );
        ...
        final lineName =
            lineData?['fish_line_name']?.toString() ??
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                if (!_loading)
                  Text(
                    '${_filtered.length} tank${_filtered.length == 1 ? '' : 's'}',
                    style: GoogleFonts.spaceGrotesk(
                      ...
                      return Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 2,
                              child: _Cell(r.tankId, mono: true),
                            ),
                            Expanded(flex: 4, child: _Cell(r.line)),
                            Expanded(
                              flex: 2,
                              child: _Cell(
                                r.lastCleaning.toIso8601String().substring(
                                  0,
                                  10,
                                ),
                                mono: true,
                            ...
                            Expanded(
                              flex: 2,
                              child: _Cell(
                                r.nextCleaning.toIso8601String().substring(
                                  0,
                                  10,
                                ),
                                mono: true,
