...
class _MessageBubble extends StatefulWidget {
  ...
  final bool Function(LabMessage message) canEditMessage;
  final void Function(String type, int id) onMentionTap;
...
class _MessageBubbleState extends State<_MessageBubble> {
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        color: _hovered
            ...
            : msg.pinned
            ? AppDS.yellow.withValues(alpha: 0.025)
            : Colors.transparent,
        child: Padding(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        'Pinned',
                        style: _mono(size: 9, color: AppDS.yellow),
                      ),
                    ],
                  ),
                ),
                        ...
                        : GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: aColor.withValues(alpha: 0.35),
                                ),
                              ),
                              child: Center(
                                child: Text(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        widget.editingMessageId == msg.id
  ...
  // Render @ mentions and legacy context tags as linked chips.
      ...
      spans.add(
        WidgetSpan(
          ...
          child: Padding(
            ...
            child: _ContextTag(
              type: m.group(1)!,
              id: int.tryParse(m.group(2)!),
              label: m.group(3),
              onTap: () =>
                  widget.onMentionTap(m.group(1)!, int.parse(m.group(2)!)),
            ),
          ),
        ),
      );
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Text(
              'Enter to save',
              style: _mono(size: 9, color: ctx.appTextMuted),
            ),
          ],
        ),
      ],
  ...
  Widget _pill(String label, Color color, VoidCallback onTap) => InkWell(
    onTap: onTap,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const Spacer(),
                          if (widget.canEditMessage(r) &&
                              widget.editingMessageId != r.id)
                            _aBtn(
                              ctx,
                              Icons.edit_outlined,
                              'Edit reply',
                      ...
                      widget.editingMessageId == r.id
                          ? _buildEditField(ctx, r)
                          : _buildBodyText(r.body),
                    ],
                  ),
                ),
              ],
...
class _ContextTag extends StatelessWidget {
  ...
  const _ContextTag({required this.type, this.id, this.label, this.onTap});

  @override
  Widget build(BuildContext context) {
    const colors = <String, Color>{
      'fishline': Color(0xFF00C8F0),
      'fish_lines': Color(0xFF00C8F0),
      'fish_stocks': Color(0xFF00D98A),
      'users': Color(0xFF60A5FA),
      'strain': Color(0xFF9B72CF),
      'strains': Color(0xFF9B72CF),
      'sample': Color(0xFFFF8C42),
      'samples': Color(0xFFFF8C42),
      'reagent': Color(0xFFFF4D6D),
      'reagents': Color(0xFFFF4D6D),
      'equipment': Color(0xFF7A9CBF),
      'machines': Color(0xFF7A9CBF),
      'locations': Color(0xFFFBBF24),
      'protocol': Color(0xFF00D98A),
    };
    ...
    return AlertDialog(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(
                          t.$2,
                          size: 13,
                          color: sel ? t.$3 : context.appTextMuted,
                        ),
      ...
      actions: [
        TextButton(
          ...
          child: Text(
            'Cancel',
            style: _body(size: 13, color: context.appTextMuted),
          ),
        ),
        ElevatedButton(
