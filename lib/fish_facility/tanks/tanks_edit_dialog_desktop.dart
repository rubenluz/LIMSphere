...
class _EditTankDialogState extends State<_EditTankDialog> {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDateRow(
                ...
                onToday: () => setState(() => _lastBreeding = _today),
        ...
        ElevatedButton(
          ...
          onPressed: () {
            if (_isOccupied(_col) && _newTankId != widget.tank.zebraTankId) {
              setState(
                () => _posError = 'Tank $_newTankId is already occupied.',
              );
              return;
            }
            ...
            widget.onSave(
              ZebrafishTank(
                ...
                zebraResponsible: _resp.text.trim().isEmpty
                    ? null
                    : _resp.text.trim(),
                zebraStatus: _status,
                ...
                zebraExperimentId: _exp.text.trim().isEmpty
                    ? null
                    : _exp.text.trim(),
                zebraNotes: _notes.text.trim().isEmpty
                    ? null
                    : _notes.text.trim(),
  ...
  Widget _buildCleaningRow() => _buildDateRow(
    ...
    onToday: () => setState(() => _lastCleaning = _today),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Red = already occupied by another stock.',
            style: GoogleFonts.jetBrainsMono(
              fontSize: 10,
              color: context.appTextMuted,
            ),
