...
class _FishLinesPageState extends State<FishLinesPage> {
    ...
    try {
      ...
      final stockRows =
          (await Supabase.instance.client
                      .from('fish_stocks')
                      .select(
                        'fish_stocks_line_id, fish_stocks_males, fish_stocks_females, fish_stocks_juveniles',
                      )
                      .not('fish_stocks_line_id', 'is', null)
                  as List<dynamic>)
              .cast<Map<String, dynamic>>();
  ...
  void _applyFilters() {
    ...
    if (_filterType != null)
      d = d.where((r) => r.fishlineType == _filterType).toList();
    if (_filterStatus != null)
      d = d.where((r) => r.fishlineStatus == _filterStatus).toList();
    if (_filterReporter != null)
      d = d.where((r) => r.fishlineReporter == _filterReporter).toList();
    ...
    d.sort((a, b) {
      ...
      switch (_sortKey) {
        ...
        case 'fishlineStatus':
          ...
          bv = b.fishlineStatus ?? '';
          break;
        case 'fishlineZygosity':
          av = a.fishlineZygosity ?? '';
          bv = b.fishlineZygosity ?? '';
          break;
        case 'fishlineGeneration':
          av = a.fishlineGeneration ?? '';
          bv = b.fishlineGeneration ?? '';
          break;
        case 'fishlineAffectedGene':
          av = a.fishlineAffectedGene ?? '';
          bv = b.fishlineAffectedGene ?? '';
          break;
        case 'fishlineOriginLab':
          av = a.fishlineOriginLab ?? '';
          bv = b.fishlineOriginLab ?? '';
          break;
        case 'fishlineDateBirth':
        case 'ageDays':
        case 'ageMonths':
          av = a.fishlineDateBirth ?? DateTime(0);
          bv = b.fishlineDateBirth ?? DateTime(0);
          break;
        case 'stockMales':
          av = a.stockMales;
          bv = b.stockMales;
  ...
  void _openDetail(FishLine line) {
    Navigator.push(
      ...
      modulePageRoute(
        context: context,
        child: FishLineDetailPage(fishLine: line, onSaved: _loadLines),
      ),
    );
  }
  ...
  Future<void> _exportCsv() async {
    ...
    buf.writeln(
      'ID,Name,Alias,Type,Status,Zygosity,Generation,Gene,Reporter,Tissue,Origin Lab,DOB,Source,ZFIN ID,Cryopreserved,SPF,Males,Females,Juveniles,Total,Notes',
    );
    for (final l in _filtered) {
      ...
      buf.writeln(
        [
          ...
          l.fishlineDateBirth != null
              ? l.fishlineDateBirth!.toIso8601String().substring(0, 10)
              : '',
    ...
    try {
      ...
      final file = File(
        '${dir.path}/fish_lines_${DateTime.now().millisecondsSinceEpoch}.csv',
      );
        ...
        children: [
          Row(
            children: [
              ...
              ...const ['WT', 'transgenic', 'mutant', 'CRISPR', 'KO'].map(
                (t) => Padding(
          ...
          Row(
            children: [
              ...
              ...const ['active', 'archived', 'cryopreserved', 'lost'].map(
                (s) => Padding(
                  padding: const EdgeInsets.only(left: 6),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _menuCell(line, 'fishlineZygosity', 110, const [
            'homozygous',
            'heterozygous',
            'unknown',
          ]),
          _menuCell(line, 'fishlineGeneration', 60, const [
            'F1',
            'F2',
            'F3',
            'F4',
          ...
          _menuCell(line, 'fishlineSource', 100, const [
            'ZIRC',
            'EZRC',
            'collaborator',
            'in-house',
  ...
  String? _fieldVal(FishLine l, String key) {
    switch (key) {
      case 'fishlineName':
        return l.fishlineName;
      case 'fishlineAlias':
        return l.fishlineAlias;
      case 'fishlineType':
        return l.fishlineType;
      case 'fishlineStatus':
        return l.fishlineStatus;
      case 'fishlineZygosity':
        return l.fishlineZygosity;
      case 'fishlineGeneration':
        return l.fishlineGeneration;
      case 'fishlineAffectedGene':
        return l.fishlineAffectedGene;
      case 'fishlineReporter':
        return l.fishlineReporter;
      case 'fishlineTargetTissue':
        return l.fishlineTargetTissue;
      case 'fishlineOriginLab':
        return l.fishlineOriginLab;
      case 'fishlineZfinId':
        return l.fishlineZfinId;
      case 'fishlineSpfStatus':
        return l.fishlineSpfStatus;
      case 'fishlineSource':
        return l.fishlineSource;
      case 'fishlineNotes':
        return l.fishlineNotes;
      default:
        return null;
    }
  }
  ...
  String _dbCol(String key) {
    switch (key) {
      case 'fishlineName':
        return FishSch.lineName;
      case 'fishlineAlias':
        return FishSch.lineAlias;
      case 'fishlineType':
        return FishSch.lineType;
      case 'fishlineStatus':
        return FishSch.lineStatus;
      case 'fishlineZygosity':
        return FishSch.lineZygosity;
      case 'fishlineGeneration':
        return FishSch.lineGeneration;
      case 'fishlineAffectedGene':
        return FishSch.lineAffectedGene;
      case 'fishlineReporter':
        return FishSch.lineReporter;
      case 'fishlineTargetTissue':
        return FishSch.lineTargetTissue;
      case 'fishlineOriginLab':
        return FishSch.lineOriginLab;
      case 'fishlineZfinId':
        return FishSch.lineZfinId;
      case 'fishlineSpfStatus':
        return FishSch.lineSpfStatus;
      case 'fishlineSource':
        return FishSch.lineSource;
      case 'fishlineNotes':
        return FishSch.lineNotes;
      case 'fishlineDateBirth':
        return FishSch.lineDateBirth;
      default:
        return key;
    }
  }
  ...
  void _applyLocal(FishLine l, String key, String? s) {
    switch (key) {
      ...
      case 'fishlineStatus':
        ...
        break;
      case 'fishlineZygosity':
        l.fishlineZygosity = s;
        break;
      case 'fishlineGeneration':
        l.fishlineGeneration = s;
        break;
      case 'fishlineAffectedGene':
        l.fishlineAffectedGene = s;
        break;
      case 'fishlineReporter':
        l.fishlineReporter = s;
        break;
      case 'fishlineTargetTissue':
        l.fishlineTargetTissue = s;
        break;
      case 'fishlineOriginLab':
        l.fishlineOriginLab = s;
        break;
      case 'fishlineZfinId':
        l.fishlineZfinId = s;
        break;
      case 'fishlineSpfStatus':
        l.fishlineSpfStatus = s;
        break;
      case 'fishlineSource':
        l.fishlineSource = s;
        break;
              ...
              if (selected != null) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(
                      color: AppDS.accent.withValues(alpha: 0.4),
                    ),
                  ),
                  child: Text(
  ...
  Widget _menuCell(FishLine l, String key, double w, List<String> options) {
    final val = _fieldVal(l, key);
    return GestureDetector(
      onDoubleTapDown: (d) {
  ...
  Widget _typeCell(FishLine l, double w) {
    return GestureDetector(
      onDoubleTapDown: (d) => _showMenuPicker(l, 'fishlineType', const [
        'WT',
        'transgenic',
        'mutant',
        'CRISPR',
  ...
  Widget _statusCell(FishLine l, double w) {
    return GestureDetector(
      onDoubleTapDown: (d) => _showMenuPicker(l, 'fishlineStatus', const [
        'active',
        'archived',
        'cryopreserved',
        'lost',
