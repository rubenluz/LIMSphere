...
class FishLine {
  ...
  factory FishLine.fromMap(Map<String, dynamic> m) => FishLine(
    ...
    fishlineDateBirth: m[FishSch.lineDateBirth] != null
        ? DateTime.tryParse(m[FishSch.lineDateBirth])
        : null,
    fishlineDateReceived: m[FishSch.lineDateReceived] != null
        ? DateTime.tryParse(m[FishSch.lineDateReceived])
        : null,
    ...
    fishlineCryoDate: m[FishSch.lineCryoDate] != null
        ? DateTime.tryParse(m[FishSch.lineCryoDate])
        : null,
    ...
    fishlineCreatedAt: m[FishSch.lineCreatedAt] != null
        ? DateTime.tryParse(m[FishSch.lineCreatedAt])
        : null,
    fishlineUpdatedAt: m[FishSch.lineUpdatedAt] != null
        ? DateTime.tryParse(m[FishSch.lineUpdatedAt])
        : null,
  ...
  Map<String, dynamic> toMap() => {
    ...
    FishSch.lineDateReceived: fishlineDateReceived?.toIso8601String().split(
      'T',
    )[0],
